...
public partial class NorthwndContext : DbContext
{
    ...
    public virtual DbSet<OrdersDateshippedPartitioned> OrdersDateshippedPartitioneds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasTrigger("trgOrdersLog"));

            entity.HasIndex(e => e.ShippedDate, "IX_Orders_ShippedDate");

            entity.HasIndex(e => new { e.ShippedDate, e.CustomerId }, "IX_Sales_CustomerID");
        ...
        modelBuilder.Entity<OrdersDateshippedPartitioned>(entity =>
        {
            entity.HasKey(e => e.OrderId)
                .HasName("PK_OrdersDateshipped_Partitioned_1")
                .IsClustered(false);

            entity.ToTable("OrdersDateshipped_Partitioned");

            entity.HasIndex(e => e.RequiredDate, "IX_OrdersDateshipped_Partitioned_RequiredDate");
